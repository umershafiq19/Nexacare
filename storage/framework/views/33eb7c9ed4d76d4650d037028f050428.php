                                    ...
                                    <div class="table-responsive">
                                        <table class="datatable table table-hover table-center mb-0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>#P00<?php echo e($patient->id); ?></td>
                                                    <td><?php echo e($patient->first_name , $patient->last_name); ?></td>
                                                    <td><?php echo e($patient->blood_group); ?></td>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Doctors\resources\views/admin/patients.blade.php ENDPATH**/ ?>