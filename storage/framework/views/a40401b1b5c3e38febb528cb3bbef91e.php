                        ...
                        <div class="chat-users-list">
                            <div class="chat-scroll">
                                ...
                                <a href="javascript:void(0);" class="notify-block d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="<?php echo e(asset('assets/img/patients/patient2.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="<?php echo e(asset('assets/img/patients/patient3.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-offline">
                                            <img src="<?php echo e(asset('assets/img/patients/patient4.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="<?php echo e(asset('assets/img/patients/patient5.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="<?php echo e(asset('assets/img/patients/patient6.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-offline">
                                            <img src="<?php echo e(asset('assets/img/patients/patient7.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="<?php echo e(asset('assets/img/patients/patient8.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="notify-block read-chat d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-away">
                                            <img src="<?php echo e(asset('assets/img/patients/patient9.jpg')); ?>" alt="User Image"
                                                class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                ...
                <div class="call-box incoming-box">
                    <div class="call-wrapper">
                        <div class="call-inner">
                            <div class="call-user">
                                <img alt="User Image" src="<?php echo e(asset('assets/img/patients/patient.jpg')); ?>" class="call-avatar">
            ...
            <div class="modal-body">
                ...
                <div class="call-box incoming-box">
                    <div class="call-wrapper">
                        <div class="call-inner">
                            <div class="call-user">
                                <img class="call-avatar" src="<?php echo e(asset('assets/img/patients/patient.jpg')); ?>" alt="User Image">
                                <h4>Richard Wilson</h4>
                                <span>Calling ...</span>
                            </div>
                            <div class="call-items">
...
<?php /**PATH C:\xampp\htdocs\Laravel\Doctors\resources\views/chat-doctor.blade.php ENDPATH**/ ?>